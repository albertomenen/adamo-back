...
def json_to_data(response):
    ...
    color_image1 = cv2.resize(color_image1, (480, color_image1.shape[0]))
    color_image1 = color_image1[:640, :]

    color_image2 = cv2.resize(color_image2, (480, color_image2.shape[0]))
    color_image2 = color_image2[:640, :]

    depth_image1 = cv2.resize(depth_image1, (480, depth_image1.shape[0]))
    depth_image1 = depth_image1[:640, :]

    depth_image2 = cv2.resize(depth_image2, (480, depth_image2.shape[0]))
