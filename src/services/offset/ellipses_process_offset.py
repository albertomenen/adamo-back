...
def metodo_elipse(puntos_tratamiento, imagen1, imagen2, contorno1, contorno2, depth_image1, depth_image2, intrinsics1,
                  intrinsics2, depth_scale1, depth_scale2):
    ...
    mat = np.matrix([[np.cos(np.deg2rad(angulo)), -np.sin(np.deg2rad(angulo))],
                     [np.sin(np.deg2rad(angulo)), np.cos(np.deg2rad(angulo))]])
    ...
    for i in range(len(puntos_tratamiento)):
        vector3D_1[i] = Map_2D_To_3D(intrinsics1, [int(puntos1[i, 0]), int(puntos1[i, 1])],
                                     puntos_tratamiento[i, 2] / depth_scale1)
        vector3D_2[i] = Map_2D_To_3D(intrinsics2, [int(puntos2[i, 0]), int(puntos2[i, 1])],
                                     puntos_tratamiento[i, 2] / depth_scale2)
...
def desplazamiento_espalda_metodo1(color_image1, depth_image1, color_image2, depth_image2, intrinsics1, intrinsics2,
                                   depth_scale1, depth_scale2, puntos_tratamiento, grafico, precision):
    ...
    estado = True
    offset, imagen1, imagen2 = metodo_elipse(puntos_tratamiento, imagen1, imagen2, contorno1, contorno2, depth_image1,
                                             depth_image2, intrinsics1, intrinsics2, depth_scale1, depth_scale2)
...
def desplazamiento_espalda_metodo2(color_image1, depth_image1, color_image2, depth_image2, intrinsics1, intrinsics2,
                                   depth_scale1, depth_scale2, puntos_tratamiento, grafico, precision):
    imagen1 = copy.deepcopy(color_image1)
    imagen2 = copy.deepcopy(color_image2)
...
def desplazamiento_espalda_metodo3(color_image1, depth_image1, color_image2, depth_image2, intrinsics1, intrinsics2,
                                   depth_scale1, depth_scale2, puntos_tratamiento, grafico, precision):
    imagen1 = copy.deepcopy(color_image1)
    imagen2 = copy.deepcopy(color_image2)
...
def desplazamiento_espalda_metodo4(color_image1, depth_image1, color_image2, depth_image2, intrinsics1, intrinsics2,
                                   depth_scale1, depth_scale2, puntos_tratamiento, grafico, precision):
    imagen1 = copy.deepcopy(color_image1)
    imagen2 = copy.deepcopy(color_image2)
    # Se les borra el fondo a las imagenes en color 
...
def desplazamiento_espalda_contornos(color_image1, depth_image1, color_image2, depth_image2, intrinsics1, intrinsics2,
                                     depth_scale1, depth_scale2, puntos_tratamiento, grafico, precision=0.05):
    ...
    estado4, offset4 = desplazamiento_espalda_metodo4(color_image1, depth_image1, color_image2, depth_image2,
                                                      intrinsics1, intrinsics2, depth_scale1, depth_scale2,
                                                      puntos_tratamiento, grafico, precision)
